...
void Init_emptybottle()
{
   ...
   delay(5000);
   temp_wtr = scale.get_units(10);                                 //Getting the weight of empty bottle
   bottle_wt = temp_wtr * calib;
...
void Init_fullbottle()
{
  ...
  // water_curr1=(water_curr*12)/2.5296;
   water_curr2=water_curr1 * calib;; 
  }
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
void loop() 
{
  if(Serial.available())
  {
    ...
    //water_test1=(water_test*12)/2.04;
    //water_test2=water_test1/15;
    water_test2=(water_test)* calib;
